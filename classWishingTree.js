...
(function () {
  ...
  const wishesListMock = [
    {
      author: "Lớp trưởng",
      text: "Chúc tập thể 12A1 của chúng mình luôn đoàn kết, yêu thương nhau. Mong rằng tất cả các bạn đều đạt điểm cao trong kỳ thi tốt nghiệp sắp tới và bước chân vào ngôi trường Đại học mong ước!",
      theme: "red",
      time: now - 5 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Ước mong đỗ nguyện vọng 1 vào Đại học Bách Khoa Hà Nội ngành CNTT! 12A1 quyết thắng!",
      theme: "green",
      time: now - 15 * 60 * 1000,
    },
    {
      author: "Minh Tuấn",
      text: "Mong rằng tớ sẽ đạt điểm IELTS 8.0 trong năm nay để đi du học thuận lợi.",
      theme: "gold",
      time: now - 35 * 60 * 1000,
    },
    {
      author: "Quỳnh Anh",
      text: "Chúc cho tình bạn của chúng ta mãi bền chặt, dù sau này mỗi đứa một phương trời.",
      theme: "red",
      time: now - 50 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Ước gì học kỳ này cả tổ 3 đều được học sinh giỏi!",
      theme: "green",
      time: now - 72 * 60 * 1000,
    },
    {
      author: "Bảo Nam",
      text: "Chúc thầy cô luôn mạnh khỏe và lớp mình đỗ tốt nghiệp 100%.",
      theme: "gold",
      time: now - 2 * 60 * 60 * 1000,
    },
    {
      author: "Cậu bé bàn cuối",
      text: "Tớ thầm ước cô bạn ngồi bàn đầu tổ 2 luôn vui vẻ và hạnh phúc. Mong là sau này chúng mình vẫn giữ liên lạc với nhau nhé.",
      theme: "red",
      time: now - 2.5 * 60 * 60 * 1000,
    },
    {
      author: "Lớp phó học tập",
      text: "Chúc cả lớp thi cử thật suôn sẻ, đề thi trúng tủ! 10 năm sau họp lớp, ai trong chúng mình cũng đã có một sự nghiệp thành công rực rỡ nhé!",
      theme: "gold",
      time: now - 5 * 60 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Gửi thời thanh xuân tươi đẹp nhất! Cảm ơn thầy cô và tất cả các bạn học đã cùng đồng hành tạo nên những kỷ niệm học sinh không bao giờ quên.",
      theme: "green",
      time: now - 18 * 60 * 60 * 1000,
    },
    {
      author: "Vy Vy",
      text: "Ước mơ nhỏ bé của tớ là trở thành một nhà thiết kế thời trang tài năng. Chúc lớp mình luôn giữ mãi ngọn lửa đam mê!",
      theme: "gold",
      time: now - 28 * 60 * 60 * 1000,
    },
    {
      author: "Hoàng Long",
      text: "Mong đỗ vào Đại học Kinh tế Quốc dân ngành Quản trị Kinh doanh!",
      theme: "green",
      time: now - 32 * 60 * 60 * 1000,
    },
    {
      author: "Phương Thảo",
      text: "Chúc cho cả lớp mình ai cũng tìm thấy hạnh phúc riêng và thành công trên con đường đã chọn.",
      theme: "red",
      time: now - 36 * 60 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Cảm ơn thanh xuân vì đã cho tớ gặp gỡ những người bạn tuyệt vời nhất ở 12A1.",
      theme: "red",
      time: now - 42 * 60 * 60 * 1000,
    },
    {
      author: "Đức Anh",
      text: "Chiến thắng kỳ thi tốt nghiệp THPT Quốc gia! 12A1 tiến lên!",
      theme: "green",
      time: now - 45 * 60 * 60 * 1000,
    },
    {
      author: "Khánh Linh",
      text: "Chúc cho cô chủ nhiệm luôn giữ vững ngọn lửa nhiệt huyết để dẫn dắt các thế hệ học trò.",
      theme: "gold",
      time: now - 48 * 60 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Mong ước gia đình luôn bình an, mạnh khỏe và luôn ủng hộ những quyết định của tớ.",
      theme: "green",
      time: now - 52 * 60 * 60 * 1000,
    },
    {
      author: "Tuấn Kiệt",
      text: "Hi vọng sau này tớ sẽ trở thành một kiến trúc sư thiết kế nên những công trình vĩ đại.",
      theme: "gold",
      time: now - 60 * 60 * 1000,
    },
    {
      author: "Thu Hà",
      text: "Nhớ mãi những buổi chiều cùng nhau ăn vặt cổng trường và ôn thi mệt mỏi.",
      theme: "red",
      time: now - 65 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Ước mơ đỗ vào trường Đại học Ngoại thương ngành Kinh tế đối ngoại!",
      theme: "green",
      time: now - 72 * 60 * 1000,
    },
    {
      author: "Hữu Phước",
      text: "Chúc cho câu lạc bộ bóng đá trường mình luôn phát triển mạnh mẽ.",
      theme: "gold",
      time: now - 80 * 60 * 1000,
    },
    {
      author: "Tuyết Mai",
      text: "Mong rằng tớ có thể đi du lịch khắp thế giới cùng người thân yêu.",
      theme: "red",
      time: now - 90 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Chúc các thầy cô giáo luôn giữ mãi nụ cười trên môi mỗi khi đứng lớp.",
      theme: "green",
      time: now - 100 * 60 * 1000,
    },
    {
      author: "Hải Đăng",
      text: "Mong đỗ vào Học viện Bưu chính Viễn thông ngành An toàn thông tin!",
      theme: "green",
      time: now - 110 * 60 * 1000,
    },
    {
      author: "Ngọc Trâm",
      text: "Chúc cho bản thân luôn tự tin, kiên cường vượt qua mọi khó khăn thử thách phía trước.",
      theme: "red",
      time: now - 120 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Ước gì được quay lại năm lớp 10 để sửa chữa những sai lầm ngớ ngẩn ngày xưa.",
      theme: "green",
      time: now - 130 * 60 * 1000,
    },
    {
      author: "Thành Đạt",
      text: "Chúc cho ước mơ trở thành một phi công của tớ sớm thành hiện thực.",
      theme: "gold",
      time: now - 140 * 60 * 1000,
    },
    {
      author: "Mỹ Duyên",
      text: "Ước mong đỗ vào Đại học Y Hà Nội ngành Bác sĩ Đa khoa!",
      theme: "red",
      time: now - 150 * 60 * 1000,
    },
    {
      author: "Ẩn danh",
      text: "Chúc cho người tớ yêu thầm suốt 3 năm luôn vui vẻ, hạnh phúc và thành công.",
      theme: "red",
      time: now - 160 * 60 * 1000,
    },
    {
      author: "Quang Huy",
      text: "Mong đỗ Đại học Giao thông Vận tải ngành Kỹ thuật ô tô!",
      theme: "green",
      time: now - 170 * 60 * 1000,
    },
    {
      author: "Nhật Minh",
      text: "12A1 mãi là ký ức đẹp nhất trong tim mỗi chúng ta. Tạm biệt thời học sinh!",
      theme: "gold",
      time: now - 180 * 60 * 1000,
    },
  ];
  ...
  function openWishDetail(wish) {
    ...
    modal.querySelector(".wish-card-time").textContent = formatRelativeTime(
      wish.time,
    );
  ...
  window.initWishingTree = function () {
    ...
    if (wishingForm) {
      ...
      newForm.addEventListener("submit", function (e) {
        ...
        const themeRadio = newForm.querySelector(
          'input[name="wish-theme"]:checked',
        );
        ...
        authorInput.value = "";
        messageInput.value = "";
        const defaultTheme = newForm.querySelector(
          'input[name="wish-theme"][value="red"]',
        );
